/** Google "G" mark in official brand colors. */
export function GoogleIcon({ className }: { className?: string }) {
    return (
        <svg className={className} viewBox="0 0 48 48" aria-hidden="true">
            ...
            <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3a12 12 0 0 1-4.1 5.6l6.2 5.2C39.9 34.9 44 30 44 24c0-1.2-.1-2.4-.4-3.5Z" />
        </svg>
    );
}
